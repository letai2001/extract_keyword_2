...
def main():
    ...
    input_day_str = input_day.strftime("%Y/%m/%d 00:00:01")
    ...
    while current_day <= input_day:
        ...
        if not any(record['date'] == current_day_str for record in historical_data):
            ...
            top_keywords = calculate_top_keywords(current_day_str, extracted_keywords, 'keyword_percentages_main_title.json' , stop_words)
            # Hiển thị kết quả
